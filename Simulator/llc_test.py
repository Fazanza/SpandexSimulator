...
msg = Msg(msg_type.ReqV, 128, Node.GPU, Node.LLC, 0, Node.NULL)
...
llc_controller.receieve_req_msg(msg_type.ReqOdata, 128, Node.CPU1, Node.LLC, 0, Node.NULL)
llc_controller.receieve_req_msg(msg_type.ReqOdata, 256, Node.CPU2, Node.LLC, 0, Node.NULL)
llc_controller.receieve_req_msg(msg_type.ReqOdata, 384, Node.CPU3, Node.LLC, 0, Node.NULL)
llc_controller.receieve_req_msg(msg_type.ReqOdata, 512, Node.GPU, Node.LLC, 0, Node.NULL)
llc_controller.receieve_req_msg(msg_type.ReqS, 640, Node.CPU0, Node.LLC, 0, Node.NULL)
