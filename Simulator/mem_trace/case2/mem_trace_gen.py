...
# Case 1, 1 cpu 4 gpu, the cpu dispatch task to gpu
...
with open('gpu0.txt', 'w') as file:
    file.write("Barrier 0 2\n")
    gpu_write_block(secA_start, secA_end, 2000, file)

with open('gpu1.txt', 'w') as file:
    file.write("Barrier 1 2\n")
    gpu_write_block(secB_start, secB_end, 2000, file)

with open('gpu2.txt', 'w') as file:
    file.write("Barrier 2 2\n")
    gpu_write_block(secC_start, secC_end, 2000, file)

with open('gpu3.txt', 'w') as file:
    file.write("Barrier 3 2\n")
    gpu_write_block(secD_start, secD_end, 2000, file)
